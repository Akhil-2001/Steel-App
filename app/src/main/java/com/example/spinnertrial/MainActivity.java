...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    void bundles() {
        ...
        if (!b[0].getText().toString().equals("")) {
            n[0] = Integer.parseInt(b[0].getText().toString())*47;
            n[1] = Integer.parseInt(b[0].getText().toString())*10;

            c[0].setText(String.valueOf(n[0]));
            d[0].setText(String.valueOf(n[1]));
        }
        else
        {
            c[0].setText("");
        ...
        if (!b[1].getText().toString().equals("")) {
            n[0] = Integer.parseInt(b[1].getText().toString())*53;
            n[1] = Integer.parseInt(b[1].getText().toString())*7;
            c[1].setText(String.valueOf(n[0]));
            d[1].setText(String.valueOf(n[1]));
        }
        else
        {
            c[1].setText("");
        ...
        if (!b[2].getText().toString().equals("")) {
            n[0] = Integer.parseInt(b[2].getText().toString())*53;
            n[1] = Integer.parseInt(b[2].getText().toString())*5;
            c[2].setText(String.valueOf(n[0]));
            d[2].setText(String.valueOf(n[1]));
        }
        else
        {
            c[2].setText("");
        ...
        if (!b[3].getText().toString().equals("")) {
            n[0] = Integer.parseInt(b[3].getText().toString())*56;
            n[1] = Integer.parseInt(b[3].getText().toString())*3;
            c[3].setText(String.valueOf(n[0]));
            d[3].setText(String.valueOf(n[1]));
        }
        else
        {
            c[3].setText("");
        ...
        if (!b[4].getText().toString().equals("")) {
            n[0] = Integer.parseInt(b[4].getText().toString())*59;
            n[1] = Integer.parseInt(b[4].getText().toString())*2;
            c[4].setText(String.valueOf(n[0]));
            d[4].setText(String.valueOf(n[1]));
        }
        else
        {
            c[4].setText("");
    ...
    void kgs() {
        ...
        int n[] = new int[2];
        if (!b[0].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[0].getText().toString())/47);
            n[1] = (int) Math.ceil(Double.parseDouble(b[0].getText().toString())/4.7);
            c[0].setText(String.valueOf(n[0]));
            d[0].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[1].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[1].getText().toString())/53);
            n[1] = (int) Math.ceil((Double.parseDouble(b[1].getText().toString())*7)/53);
            c[1].setText(String.valueOf(n[0]));
            d[1].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[2].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[2].getText().toString())/53);
            n[1] = (int) Math.ceil((Double.parseDouble(b[2].getText().toString())*5)/53);
            c[2].setText(String.valueOf(n[0]));
            d[2].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[3].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[3].getText().toString())/56);
            n[1] = (int) Math.ceil((Double.parseDouble(b[3].getText().toString())*3)/56);
            c[3].setText(String.valueOf(n[0]));
            d[3].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[4].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[4].getText().toString())/59);
            n[1] = (int) Math.ceil((Double.parseDouble(b[4].getText().toString())*2)/59);
            c[4].setText(String.valueOf(n[0]));
            d[4].setText(String.valueOf(n[1]));
        }
        else
    ...
    void rods() {
        ...
        int n[] = new int[2];
        if (!b[0].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[0].getText().toString())/10);
            n[1] = (int) Math.ceil(Double.parseDouble(b[0].getText().toString())*4.7);
            c[0].setText(String.valueOf(n[0]));
            d[0].setText(String.valueOf(n[1]));
        }
        ...
        if (!b[1].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[1].getText().toString())/7);
            n[1] = (int) Math.ceil((Double.parseDouble(b[1].getText().toString())*53)/7);
            c[1].setText(String.valueOf(n[0]));
            d[1].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[2].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[2].getText().toString())/5);
            n[1] = (int) Math.ceil((Double.parseDouble(b[2].getText().toString())*53)/5);
            c[2].setText(String.valueOf(n[0]));
            d[2].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[3].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[3].getText().toString())/3);
            n[1] = (int) Math.ceil((Double.parseDouble(b[3].getText().toString())*56)/3);
            c[3].setText(String.valueOf(n[0]));
            d[3].setText(String.valueOf(n[1]));
        }
        else
        ...
        if (!b[4].getText().toString().equals("")) {
            n[0] = (int) Math.ceil(Double.parseDouble(b[4].getText().toString())/2);
            n[1] = (int) Math.ceil((Double.parseDouble(b[4].getText().toString())*59)/2);
            c[4].setText(String.valueOf(n[0]));
            d[4].setText(String.valueOf(n[1]));
        }
        else
